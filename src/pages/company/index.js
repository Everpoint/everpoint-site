      ...
      <CompanyContainer>
        ...
        <Section>
          <Article>
            <H2>Кто мы</H2>
            <Paragraph>
              Мы создали компанию Everpoint, чтобы сделать весь потенциал пространственных данных
              доступным для всех видов бизнеса и управления территориями. Чтобы показать, что
              геоинформационные системы - не просто сложные карты, работать с которыми могут только
              профессионалы, а современный инструмент, который способен сэкономить ваше время и
              ресурсы. Масштабы задач, которые могут решить ГИС, ничем не ограничены: будь то выбор
              места для открытия маленькой торговой точки или планирование целых городов. В этом
              помогает наш основной продукт — геоинформационная платформа EverGIS. Она предназначена
              для хранения, отображения, анализа и обработки больших геоданных.
            </Paragraph>
            <Paragraph>
        ...
        <Section className={styles.ourClients}>
          <Article>
            ...
            <Paragraph>
              ...
              проекта и которые хотят принимать каждое решение, основываясь на объективных данных.
              Среди них Газпром нефть, Сбербанк, Федеральная корпорация по развитию малого и
              среднего предпринимательства, Правительство Москвы, Институт экологического
              проектироваия и изысканий. Мы рады таким сложным задачам: каждый реализованный проект
              помогает нам развивать свою ГИС-платформу и совершенствовать те продукты и решения,
              которые мы предлагаем. Наша команда увлечена веб-картографией и геомаркетингом, но мы
              постоянно исследуем новые сферы применения геоаналитики и становимся экспертами в
              новых областях.
            </Paragraph>
          </Article>
        </Section>
