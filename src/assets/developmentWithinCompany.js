  ...
  blocks: [
    {
      name: "Сложные задачи",
      description:
        "Мы доверяем даже начинающему специалисту интересные, но трудные задачи, чтобы он мог ускорить свой рост и прокачать навыки. Если вы хотите проявить свой потенциал, мы не будем вас сдерживать, напротив, менторы помогут в этом. ",
      icon: ic1,
    },
    {
    ...
    },
    {
      name: "Обмен знаниями",
      description:
        "Наши сотрудники - это увлеченные, компетентные и открытые к общению люди. Начинающий специалист сможет многому научиться у наших сотрудников, которые стояли у истоков развития ГИС в России. А опытный профессионал найдет для себя команду единомышленников.",
      icon: ic3,
    },
    {
      name: "Карьерный рост",
